...
-- =====================================================================
-- BAGIAN 7 — TRANSACTION_CATEGORIES (asal: migrations/08_transaction_categories.sql)
-- Konversi enum transaction_type ke tabel agar kategori dapat ditambah
-- via UI. Idempotent.
-- =====================================================================
...
-- =====================================================================
-- BAGIAN 8 — INVENTORY_PIVOT DINAMIS (asal: migrations/09_inventory_pivot_dynamic.sql)
-- Long format: satu baris per (lokasi, produk, kategori). Frontend pivot.
-- =====================================================================
